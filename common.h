...
{
    ISliceLayer* s1 = network->addSlice(input, Dims32{4, {0, 0, 0, 0}}, Dims32{4, {1, inch, Yolo::INPUT_H / 2, Yolo::INPUT_W / 2}}, Dims32{4, {1, 1, 2, 2}});
    ISliceLayer* s2 = network->addSlice(input, Dims32{4, {0, 0, 1, 0}}, Dims32{4, {1, inch, Yolo::INPUT_H / 2, Yolo::INPUT_W / 2}}, Dims32{4, {1, 1, 2, 2}});
    ISliceLayer* s3 = network->addSlice(input, Dims32{4, {0, 0, 0, 1}}, Dims32{4, {1, inch, Yolo::INPUT_H / 2, Yolo::INPUT_W / 2}}, Dims32{4, {1, 1, 2, 2}});
    ISliceLayer* s4 = network->addSlice(input, Dims32{4, {0, 0, 1, 1}}, Dims32{4, {1, inch, Yolo::INPUT_H / 2, Yolo::INPUT_W / 2}}, Dims32{4, {1, 1, 2, 2}});
